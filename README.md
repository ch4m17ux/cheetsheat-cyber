...
john id_rsa.hash 
-- Si tengo un diccionario: john --wordlist=dict.txt id_rsa.hash
...
#### HASHCAT  - Sacar contrase?a donde sabemos que esta en MD5
...
6. Para tener una shell mas funcional
